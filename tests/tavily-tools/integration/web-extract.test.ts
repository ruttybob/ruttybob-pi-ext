...
import { createTavilyClient } from "../../../extensions/tavily-tools/tools/tavily/client.js";
import { registerWebExtractTool } from "../../../extensions/tavily-tools/tools/web-extract.js";
...
describe.skip("web_extract integration tests (stubs - no real API)", () => {
  describe("with real Tavily API", () => {
