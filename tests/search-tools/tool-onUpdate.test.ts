...
import { createWebSearchTool } from '../../extensions/search-tools/src/tools/web-search-tool.js';
import { createWebReaderTool } from '../../extensions/search-tools/src/tools/web-reader-tool.js';
import { createZreadSearchDocTool } from '../../extensions/search-tools/src/tools/zread-search-doc-tool.js';
import { createZreadGetRepoStructureTool } from '../../extensions/search-tools/src/tools/zread-get-repo-structure-tool.js';
import { createZreadReadFileTool } from '../../extensions/search-tools/src/tools/zread-read-file-tool.js';
import { createVisionAnalyzeImageTool } from '../../extensions/search-tools/src/tools/vision-analyze-image-tool.js';
import { createVisionAnalyzeVideoTool } from '../../extensions/search-tools/src/tools/vision-analyze-video-tool.js';
import { createVisionUiToArtifactTool } from '../../extensions/search-tools/src/tools/vision-ui-to-artifact-tool.js';
import { createVisionExtractTextTool } from '../../extensions/search-tools/src/tools/vision-extract-text-tool.js';
import { createVisionDiagnoseErrorTool } from '../../extensions/search-tools/src/tools/vision-diagnose-error-tool.js';
import { createVisionUnderstandDiagramTool } from '../../extensions/search-tools/src/tools/vision-understand-diagram-tool.js';
import { createVisionAnalyzeDataVizTool } from '../../extensions/search-tools/src/tools/vision-analyze-data-viz-tool.js';
import { createVisionUiDiffCheckTool } from '../../extensions/search-tools/src/tools/vision-ui-diff-check-tool.js';
