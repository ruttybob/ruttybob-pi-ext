/**
 * Схемы параметров Tavily-инструментов.
 *
 * Перенесено из extensions/tavily-tools/tools/tavily/schemas.ts.
 */
...
// Используются WebSearchParamsSchema и WebExtractParamsSchema выше.
// Базовые схемы вынесены в соответствующие Object-схемы для type-safety.
