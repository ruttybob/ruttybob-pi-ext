/**
 * Runner — lifecycle child-процессов subagent.
 *
 * Инкапсулирует запуск pi-процессов, concurrency-лимитер,
 * парсинг JSON-вывода и извлечение display-элементов.
 */
...
/**
 * Определяет команду и аргументы для запуска pi-процесса.
 */
...
/**
 * Запускает один subagent-процесс и собирает результат.
 */
