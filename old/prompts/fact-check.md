...
**Язык:** Все пояснения, комментарии, вердикты проверки и текст на выходе — **обязательно на русском языке**. Код и технические идентификаторы остаются на английском.
